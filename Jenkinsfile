pipeline {
    agent {
        docker {
            ...
            args '-u root:root -v /root/jenkins/lic/Unity_v2022.x.ulf:/root/.local/share/unity3d/Unity/Unity_v2022.x.ulf  -e UNITY_LICENSE_PATH=/root/.local/share/unity3d/Unity/Unity_v2022.x.ulf -v /tmp/.X11-unix:/tmp/.X11-unix:rw --privileged'
        }
    }
    stages {
        stage('Build') {
